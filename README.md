...
🔧 Install the Service
python PythonBackupService.py install ▶️ Start the Service
python PythonBackupService.py start ⏹️ Stop the Service
python PythonBackupService.py stop ❌ Remove the Service
